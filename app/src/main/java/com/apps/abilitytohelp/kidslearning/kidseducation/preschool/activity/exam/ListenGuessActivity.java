package com.apps.abilitytohelp.kidslearning.kidseducation.preschool.activity.exam;
...
import com.apps.abilitytohelp.kidslearning.kidseducation.preschool.adapter.ListenGuessAdapter;
...
//    TextToSpeech textToSpeech;
    ...
    public void prepareDataForLearning(int i2) {
        if (i2 == 0) {
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.purple, "Purple", "Purple"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cyan, "Cyan", "Cyan"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.magenta, "Magenta", "Magenta"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.maroon, "Maroon", "Maroon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.navy, "Navy", "Navy"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.teal, "Teal", "Teal"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.lavender_color, "Lavender", "Lavender"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.indigo, "Indigo", "Indigo"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.turquoise, "Turquoise", "Turquoise"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.gray, "Gray", "Gray"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.beige, "Beige", "Beige"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.olive, "Olive", "Olive"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.peach, "Peach", "Peach"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.coral, "Coral", "Coral"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.gold, "Gold", "Gold"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.silver, "Silver", "Silver"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rose_color, "Rose", "Rose"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.skyblue, "Sky Blue", "Sky Blue"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tan, "Tan", "Tan"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.burgundy, "Burgundy", "Burgundy"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.prism, "Prism", "Prism"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.pyramid, "Pyramid", "Pyramid"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.torus, "Torus", "Torus"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.heptagon, "Heptagon", "Heptagon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nonagon, "Nonagon", "Nonagon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.dodecagon, "Dodecagon", "Dodecagon"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hummingbird, "Hummingbird", "Hummingbird"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.swan, "Swan", "Swan"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.flamingo, "Flamingo", "Flamingo"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.seagull, "Seagull", "Seagull"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hawk, "Hawk", "Hawk"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bluejay, "Blue Jay", "Blue Jay"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.pelican, "Pelican", "Pelican"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.stork, "Stork", "Stork"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.falcon, "Falcon", "Falcon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.albatross, "Albatross", "Albatross"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.kiwi_fruit, "Kiwi", "Kiwi"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.orange_fruit, "Orange", "Orange"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.peach_fruit, "Peach", "Peach"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.banana, "Banana", "Banana"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cranberry, "Cranberry", "Cranberry"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.grapefruit, "Grapefruit", "Grapefruit"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.persimmon, "Persimmon", "Persimmon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.guava, "Guava", "Guava"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cabbage, "Cabbage", "Cabbage"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.zucchini, "Zucchini", "Zucchini"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.pumpkin, "Pumpkin", "Pumpkin"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.beetroot, "Beetroot", "Beetroot"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.celery, "Celery", "Celery"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.artichoke, "Artichoke", "Artichoke"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.kale, "Kale", "Kale"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.leek, "Leek", "Leek"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.peas, "Peas", "Peas"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.corn, "Corn", "Corn"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ginger, "Ginger", "Ginger"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.head, "Head", "Head"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hand, "Hand", "Hand"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.wrist, "Wrist", "Wrist"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.chin, "Chin", "Chin"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.forehead, "Forehead", "Forehead"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eyebrow, "Eyebrow", "Eyebrow"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eyelash, "Eyelash", "Eyelash"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cheek, "Cheek", "Cheek"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.jaw, "Jaw", "Jaw"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tongue, "Tongue", "Tongue"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.teeth, "Teeth", "Teeth"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tshirt, "T-shirt", "T-shirt"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hoodie, "Hoodie", "Hoodie"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tie, "Tie", "Tie"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cardigan, "Cardigan", "Cardigan"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.vest, "Vest", "Vest"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.blazer, "Blazer", "Blazer"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.poloshirt, "Polo Shirt", "Polo Shirt"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.romper, "Romper", "Romper"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.china, "China", "China"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.australia, "Australia", "Australia"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.colombia, "Colombia", "Colombia"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.turkey, "Turkey", "Turkey"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.iran, "Iran", "Iran"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nigeria, "Nigeria", "Nigeria"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.egypt, "Egypt", "Egypt"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.southafrica, "South Africa", "South Africa"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bangladesh, "Bangladesh", "Bangladesh"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.sushi, "Sushi", "Sushi"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.salad, "Salad", "Salad"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.steak, "Steak", "Steak"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tacos, "Tacos", "Tacos"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.soup, "Soup", "Soup"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hotdog, "Hot Dog", "Hot Dog"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.dumplings, "Dumplings", "Dumplings"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.paella, "Paella", "Paella"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.shawarma, "Shawarma", "Shawarma"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.burrito, "Burrito", "Burrito"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.waffles, "Waffles", "Waffles"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.omelette, "Omelette", "Omelette"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.trapezoid, "Trapezoid", "Trapezoid"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.triangle, "Triangle", "Triangle"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cube, "Square", "Square"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.octagon, "Octagon", "Octagon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rhombus, "Rhombus", "Rhombus"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.prism, "Prism", "Prism"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.torus, "Torus", "Torus"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.roof, "Roof", "Roof"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.wall, "Wall", "Wall"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bedroom, "Bedroom", "Bedroom"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bathroom, "Bathroom", "Bathroom"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.kitchen, "Kitchen", "Kitchen"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.livingroom, "Living room", "Living room"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.diningroom, "Dining room", "Dining room"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.garage, "Garage", "Garage"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.stairs, "Stairs", "Stairs"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.fireplace, "Fireplace", "Fireplace"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.attic, "Attic", "Attic"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.basement, "Basement", "Basement"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.balcony, "Balcony", "Balcony"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.garden, "Garden", "Garden"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.fence, "Fence", "Fence"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.chimney, "Chimney", "Chimney"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cupboard, "Cupboard", "Cupboard"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.schoolbus, "School bus", "School bus"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.playground, "Playground", "Playground"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.library, "Library", "Library"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.gymnasium, "Gymnasium", "Gymnasium"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.sciencelab, "Science lab", "Science lab"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.musicroom, "Music room", "Music room"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.locker, "Locker", "Locker"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.chalkboard, "Chalkboard", "Chalkboard"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.calculator, "Calculator", "Calculator"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.cricket, "Cricket", "Cricket"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.gymnastics, "Gymnastics", "Gymnastics"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rugby, "Rugby", "Rugby"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.boxing, "Boxing", "Boxing"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.wrestling, "Wrestling", "Wrestling"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.snowboarding, "Snowboarding", "Snowboarding"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rowing, "Rowing", "Rowing"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.sailing, "Sailing", "Sailing"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.climbing, "Climbing", "Climbing"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.horsebackriding, "Horseback riding", "Horseback riding"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.martialarts, "Martial Arts", "Martial Arts"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.van, "Van", "Van"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.jetski, "Jet Ski", "Jet Ski"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tractor, "Tractor", "Tractor"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.skateboard, "Skateboard", "Skateboard"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rickshaw, "Rickshaw", "Rickshaw"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.limousine, "Limousine", "Limousine"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.tank, "Tank", "Tank"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.submarine, "Submarine", "Submarine"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.hotairballoon, "Hot Air Balloon", "Hot Air Balloon"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.rocket, "Rocket", "Rocket"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.atv, "ATV", "ATV"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.bulldozer, "Bulldozer", "Bulldozer"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.go_home, "Back to home", "Back to home"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.kiss, "Bike", "Bike"));
