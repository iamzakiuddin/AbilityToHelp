package com.androidapp.abilitytohelp.broadcastmanagers;
...
import com.androidapp.abilitytohelp.activity.OnBoardingActivity;

public class DailyBroadcast extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
        Intent launchIntent = new Intent(context, OnBoardingActivity.class);
