...
import com.androidapp.abilitytohelp.interfaces.CallbackListener;
...
public class OnBoardingActivity extends AppCompatActivity implements CallbackListener {
...
/*        Handler handler = new Handler();
    ...
    private void navigateToMainMenu() {
        Intent intent = new Intent(OnBoardingActivity.this, MainMenu.class);
        startActivity(intent);
        finish();
    }
  ...
  /*  private Handler handler = new Handler();
    private Runnable myRunnable = new Runnable() {
        @Override
        public void run() {
            if (Utils.isNetworkConnected(OnBoardingActivity.this)) {
                if (!isLoaded) {
                    startNextActivity(0);
                }
            }
